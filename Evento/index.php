		...
		<!-- Intro -->
			<section id="intro" class="main style1 dark fullscreen">
				<div class="content">
					...
					<p>Welcome to <strong>Evento</strong>. It is the perfect platform to register for college events.
						 Our website offers four types of events: Technical Events, Gaming Events, On-Stage Events, and Off-Stage Events.
						  Click the arrow or scroll to explore for more!</p>
					<footer>
